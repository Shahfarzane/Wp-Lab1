...
//adding a hook function to an action 
add_action('wp_enqueue_scripts', 'my_scripts_method');
add_action( 'wp_enqueue_scripts', 'add_css_files');


// adding support for different theme options 
add_theme_support('menus');
add_theme_support( 'post-thumbnails' );
add_theme_support('widgets');

// adding image size to a thumbnail
...
// acf plugins functions , this could has been generated by ACF plugin
